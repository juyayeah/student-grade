...
<body>
<form name="stdFrm" action="${contextPath }/admin/addStudent.do" method="post" enctype="multipart/form-data">
<table>
<tr>
...
<tr>
<td colspan="3"><input type="submit" value="회원가입"/><input type=button value="취소하기" onClick="backToList(this.form)"/>
